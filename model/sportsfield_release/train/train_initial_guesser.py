...
def main():
    ...
    metrics_dir = os.path.join(opt.out_dir, 'pretrained_init_guess', f'metrics_{timestamp}')
    ...
    for epoch in range(opt.train_epochs):
        ...
        epoch_ckpt = os.path.join(opt.out_dir, 'pretrained_init_guess', f'checkpoint_epoch_{epoch+1}.pth')
    ...
    final_out_path = os.path.join(opt.out_dir, 'pretrained_init_guess', 'final_best_model.pth.tar')
